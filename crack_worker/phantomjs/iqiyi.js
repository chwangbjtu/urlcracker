	function cal(mid,vid)
	{
		var cmd5x = (function() {
			...
			for (var i = 8, j = 0; i < 73; i += 4,
			j++) {
				S[i] = S1[j]
			}
			for (var i = 209, j = 48; i <= 218; i++,
			j++)
				S[i] = j;
			for (var i = 219, j = 97; i <= 224; i++,
			j++)
				S[i] = j;
			V.set(S, 8);
			function W(Sz, s) {
						...
						if (!(c[183] & 4)) {
							...
							while (0);d: do
								if ((E | 0) == 183) {
									d = 0 - a | 0;
									do
										if (h >>> 0 > a >>> 0 & (a >>> 0 < 2147483647 & (b | 0) != (-1 | 0)) ? (w = c[192] | 0,
										w = i - a + w & 0 - w,
										w >>> 0 < 2147483647) : 0)
											if ((la(w | 0) | 0) == (-1 | 0)) {
												la(d | 0) | 0;
							...
							while (0);c[183] = c[183] | 4;
							E = 190
						} else
							E = 190;
					while (0);if ((((E | 0) == 190 ? j >>> 0 < 2147483647 : 0) ? (x = la(j | 0) | 0,
					y = la(0) | 0,
	...
	var a= "/jp/tmts/"+mid+"/"+vid;
	_ = (new Date).getTime();
	
    var b =a +"/?uid=&cupid=qc_100001_100186&platForm=h5&qyid="+"3e6c7jyigkttrxr6si1mdk1h"+"=13&type=mp4&rate=1&qdv=1&qdx=k&qds=0&__jsT=sgve&t="+_+"&src=02020031010000000000&";
	var c = b + "callback=tmtsCallback" 
	//test = "/jp/tmts/516997200/cb29af111517d976f0783f33aee29641/?uid=&cupid=qc_100001_100186&platForm=h5&qyid=ez2zcd2cboyr5xs9koq8r3nv&agenttype=13&type=mp4&rate=1&qdv=1&qds=0&__jsT=sgve&t=1471312862764&src=02020031010000000000&callback=tmtsCallback"
    //test="/jp/tmts/528085600/b6196c2a3a40c9093030a1232dcd8c2f/?uid=&cupid=qc_100001_100186&platForm=h5&qyid=3e6c7jyigkttrxr6si1mdk1h&agenttype=13&type=mp4&rate=1&qdv=1&qdx=k&qds=0&__jsT=sgve&t=1472433387620&src=02020031010000000000&callback=tmtsCallback" 
	var vf = cmd5x(c)
	return "http://cache.m.iqiyi.com"+b+"vf="+vf+"&callback=tmtsCallback"
	}
